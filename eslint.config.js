...
export default [
  {
    files: ['life-ledger-core.js', 'chronasense-life-ledger-adapter.js', 'learning-plan-model.js', 'learning-plan-repository.js', 'learning-plan-import.js', 'learning-plan-ui.js'],
    languageOptions: {
      ecmaVersion: 2022,
      sourceType: 'module',
      globals: {
  ...
  {
    files: ['*.js'],
    ignores: ['www/**', 'node_modules/**', 'life-ledger-core.js', 'chronasense-life-ledger-adapter.js', 'learning-plan-model.js', 'learning-plan-repository.js', 'learning-plan-import.js', 'learning-plan-ui.js'],
    languageOptions: {
      ecmaVersion: 2022,
