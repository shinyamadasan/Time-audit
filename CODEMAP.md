...
## [Day Templates]
Lines: 6729–6910
Purpose: Recurring block templates, selected-day Settings skeleton editor, nearby task/day add form, collapsed all-blocks advanced list, Today-row template actions, optional auto-log after scheduled end, template suppression against real/deleted entries, and hidden-on-demand Settings template form.
