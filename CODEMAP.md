...
## [Day Templates]
Lines: 6729–6910
Purpose: Recurring block templates, selected-day Settings skeleton editor, modal task/day add form, content-sized hourly weekly calendar, blank-slot calendar creation, Today-row template actions, optional auto-log after scheduled end, and template suppression against real/deleted entries.
